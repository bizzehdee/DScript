...
| Strict mode (`"use strict"`) | ⚠️ | Directive detected; compile-time errors for duplicate params, `eval`/`arguments` as binding names, `delete <identifier>`, and octal literals; `this=undefined` in plain calls — undeclared var ReferenceError and non-writable TypeError not yet implemented |
