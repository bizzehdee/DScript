...
namespace DScript.Test
{
    ...
    /// chaining. The closure back-end declines method calls (it can't share the peeked
    /// receiver without re-evaluating it).
    /// </summary>
    [TestFixture]
    [NonParallelizable]
    public class JitMethodCallTests
    {
        ...
        [Test]
        public void ClosureBackendDeclinesMethodCalls()
        {
            var src =
            ...
            Assert.That(jit.f.JitState, Is.EqualTo(Chunk.JitStatus.Failed), "closure declines method calls");
